...
<title>Project Manager | Edit ${project.title }</title>
...
<body class="text-center" style="">
	...
	<div class="mx-auto">
		<div class="card w-50 shadow-lg mx-auto p-3">
			<form:form action="/projects/${project.id }/update" modelAttribute="project" method="POST">
				...
				<input class="mb-3 btn bg-info text-light" type="submit" value="Submit" />
			</form:form>
		</div>
	</div>
